...
export class LLMCodeExecutor {
    ...
    public async executeCode(parsed: ParsedCodeBlock): Promise<CodeExecutionResult> {
...
export async function executeLLMResponse(response: string): Promise<CodeExecutionResult> {
    return llmCodeExecutor.executeMarkdown(response);
}

export async function executeLLMCode(code: string, description?: string): Promise<CodeExecutionResult> {
