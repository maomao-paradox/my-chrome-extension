!(function () {
  let formRightElement = document.querySelector(
      "#app > div > div.form-area > div.form-right",
    ),
  ...
  const originalCode = formData.code,
      ...
      if (typeof attrs === "object" && Object.keys(attrs).length > 0) {
        ...
        if (Array.isArray(children) && children.length > 0) {
          for (const child of children) {
            typeof child === "string"
              ? element.appendChild(createElement("span", { innerText: child }))
    ...
    deepUpdateFormList = (form) => {
      const formList = document.querySelector(
        "#app > div.form-design > div.form-area > div.form-main > form",
      ).__vue__.$parent.formList;
    ...
    handleSaveConfig = () => {
      ...
      (console.log(vueInstance, formData),
        hasChangedCode || formData.code !== originalCode
          ? deepUpdateFormList(formData)
          : vueInstance.$emit("change", formData));
    },
    rightAttributePanel = createElement(
      "div",
      {
        className: "form-right",
        id: "jsonDisplayContainer",
        style:
          "width: 300px; border: 1px solid #e1e3e7; background-color: #fff; overflow-y: auto;",
      },
      [
        createElement("button", {
          ...
          onclick: function () {
            (document.body.appendChild(
              ...
              (getElementById("jsonText").value = JSON.stringify(
                formData,
                null,
                2,
              )));
          ...
          [
            ...
            createElement(
              ...
              [
                createElement("button", {
                  className:
                    "el-button mt-button el-button--primary mt-button--primary",
    ...
    renderFormConfig = (value, container) => {
      ...
      if (
        ...
        value
          ? rightLabel.classList.add("is-active")
          : leftLabel.classList.add("is-active");
    ...
    updateFormData = (event) => {
      let targetElement = event.target || event.currentTarget,
        ...
        paths = (
          ...
          targetElement.parentNode.dataset.path ||
          targetElement.parentNode.parentNode.dataset.path
        ).split("."),
    ...
    closeJsonModal = () => {
      (getElementById("jsonModal").remove(),
        getElementById("v-shadow").remove());
    },
    jsonModal = createElement(
      "div",
      {
        id: "jsonModal",
      ...
      [
        createElement(
          "div",
          {
            ...
            "aria-modal": true,
            style:
              "width: 800px; height: 600px; margin: 0 auto; padding: 0; border-radius: 4px; background-color: #fff;",
          },
          [
            createElement(
              "div",
            ...
            createElement(
              "div",
              {
                ...
                style:
                  "padding: 0;width:auto;height:450px;overflow-y: inherit;",
              },
              [
                createElement("textarea", {
                  ...
                  style:
                    "width: 100%; height: 100%; border: none; resize: none; padding: 10px; font-size: 14px; line-height: 1.5;",
            ...
            createElement(
              ...
              [
                ...
                createElement("button", {
                  className:
                    "el-button mt-button el-button--submain mt-button--submain",
                  style: "width: auto;height: 30px;",
                  innerText: "取消",
                  onclick: closeJsonModal,
                }),
  ...
  (formRightElement.parentNode.appendChild(rightAttributePanel),
