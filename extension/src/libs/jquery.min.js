...
(function(e, t) {
  ...
  b.fn = b.prototype = {
    ...
    pushStack: function(e) {
      const t = b.merge(this.constructor(), e);
  ...
  b.Callbacks = function(e) {
    ...
    let t, n, r, a, s, u, l, c, p, f, d = o.createElement('div');
  ...
  b.extend({
    ...
    acceptData: function(e) {
      ...
      const t = e.nodeName && b.noData[e.nodeName.toLowerCase()];
  ...
  function W(e, n, r) {
    if (r === t && 1 === e.nodeType) {
      const i = 'data-' + n.replace(B, '-$1').toLowerCase();
  ...
  b.fn.extend({
    ...
    propHooks: {
      tabIndex: {
        get: function(e) {
          const n = e.getAttributeNode('tabindex');
  ...
  b.event = {
    ...
    add: function(e, n, r, o, a) {
      let s, u, l, c, p, f, d, h, g, m, y, v = b._data(e);
      if (v) {
    ...
    remove: function(e, t, n, r, i) {
      let o, a, s, u, l, c, p, f, d, h, g, m = b.hasData(e) && b._data(e);
      if (m && (c = m.events)) {
    ...
    simulate: function(e, t, n, r) {
      const i = b.extend(new b.Event, n, {
        type: e,
        isSimulated: !0,
        originalEvent: {}
      });
  ...
  function(e, t) {
    let n, r, i, o, a, s, u, l, c, p, f, d, h, g, m, y, v, x = 'sizzle' + -new Date,
      w = e.document,
      T = {},
      N = 0,
      C = 0,
    ...
    a = st.isXML = function(e) {
      ...
      return n !== p && 9 === n.nodeType && n.documentElement ? (p = n, f = n.documentElement, d = a(
        ...
        const t = typeof e.lastChild.getAttribute('multiple');
        ...
        const t = n.getElementsByName && n.getElementsByName(x).length === 2 + n
        ...
        const t = e.replace(et, tt);
        return function(e) {
          const n = typeof e.getAttributeNode !== A && e.getAttributeNode('id');
          return n && n.value === t;
        };
      ...
      filter: {
        ...
        CHILD: function(e, t, n, r, i) {
          ...
          return 1 === r && 0 === i ? function(e) {
            ...
            let l, c, p, f, d, h, g = o !== a ? 'nextSibling' : 'previousSibling',
              m = t.parentNode,
        ...
        PSEUDO: function(e, t) {
          let n, r = i.pseudos[e] || i.setFilters[e.toLowerCase()] || st.error(
  ...
  b.fn.extend({
    ...
    add: function(e, t) {
      const n = 'string' === typeof e ? b(e, t) : b.makeArray(e && e.nodeType ? [e] : e),
  ...
  At.optgroup = At.option, At.tbody = At.tfoot = At.colgroup = At.caption = At.thead, At.th = At.td, b.fn.extend({
    ...
    wrapAll: function(e) {
      ...
      if (this[0]) {
        const t = b(e, this[0].ownerDocument).eq(0).clone(!0);
  ...
  function Ht(e) {
    const t = e.getAttributeNode('type');
  ...
  b.extend({
    clone: function(e, t, n) {
      let r, i, o, a, s, u = b.contains(e.ownerDocument, e);
  ...
  function ln(e, t) {
    const n = b(t.createElement(e)).appendTo(t.body),
      r = b.css(n[0], 'display');
    return n.remove(), r;
  }
  ...
  function Mn(e, n) {
    let r, i, o = b.ajaxSettings.flatOptions || {};
  ...
  b.ajaxSetup({
    ...
    if (e.crossDomain) {
      let n, r = o.head || b('head')[0] || o.documentElement;
      return {
        send: function(t, i) {
  ...
  b.ajaxSetup({
    ...
    jsonpCallback: function() {
      const e = On.pop() || b.expando + '_' + vn++;
      return this[e] = !0, e;
    }
  }), b.ajaxPrefilter('json jsonp', function(n, r, i) {
    let o, a, s, u = n.jsonp !== !1 && (Bn.test(n.url) ? 'url' : 'string' === typeof n.data && !(n
  ...
  let Xn, Un, Vn = /^(?:toggle|show|hide)$/,
    Yn = RegExp('^(?:([+-])=|)(' + x + ')([a-z%]*)$', 'i'),
    Jn = /queueHooks$/,
    Gn = [nr],
    Qn = {
      '*': [function(e, t) {
        let n, r, i = this.createTween(e, t),
          o = Yn.exec(t),
          a = i.cur(),
          s = +a || 0,
          u = 1,
    ...
    var r, i, o = 0,
      ...
      l = s.promise({
        ...
        createTween: function(t, n) {
          const r = b.Tween(e, l.opts, t, n, l.opts.specialEasing[t] || l.opts.easing);
  ...
  b.Tween = rr, rr.prototype = {
    ...
    run: function(e) {
      let t, n = rr.propHooks[this.prop];
    ...
    animate: function(e, t, n, r) {
      const i = b.isEmptyObject(e),
        o = b.speed(t, n, r),
        a = function() {
          const t = er(this, b.extend({}, e), o);
          a.finish = function() {
            t.stop(!0);
  ...
  b.each({
    ...
    const r = e && 'object' === typeof e ? b.extend({}, e) : {
    ...
    offsetParent: function() {
      return this.map(function() {
        let e = this.offsetParent || o.documentElement;
