! function () {
    var formRightElement = document.querySelector("#app > div > div.form-area > div.form-right")
    ...
    const originalCode = formData.code
        ...
        , deepUpdateFormList = form => {
            var formList = document.querySelector("#app > div.form-design > div.form-area > div.form-main > form").__vue__.$parent.formList;
            ...
            for (let i = 0; i < formList.length; i++) {
                ...
                if (formList[i].children && formList[i].children.length > 0) {
                    var childFormList = formList[i].children;
        ...
        , updateFormData = event => {
            var targetElement = event.target || event.currentTarget
