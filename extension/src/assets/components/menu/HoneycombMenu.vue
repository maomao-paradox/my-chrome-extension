<template>
    <main class="site-wrapper" :style="{ borderTop: `4px solid ${borderColor}` }">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                            ...
                            <div class="hexagon-menu clear">
                                <!-- 菜单项 -->
                                <div v-for="(item, index) in menuItems" :key="index" class="hexagon-item"
                                    :class="{ 'last-row': index >= menuItems.length - 3 }"
                                    @click="handleMenuClick(item, index)"
                                    @mouseenter="handleMenuHover(item, index, true)"
                                    @mouseleave="handleMenuHover(item, index, false)">
                                    <div class="hex-item">
                                        <div></div>
                                        <div></div>
                                        <div></div>
                                    ...
                                    <a :href="item.href || '#'" class="hex-content" :target="item.target || '_self'">
...
const emit = defineEmits<{
    // 菜单点击事件
    (e: 'menu-click', item: MenuItem, index: number): void;
    // 菜单悬停事件
    (e: 'menu-hover', item: MenuItem, index: number, isHovering: boolean): void;
}>();
