...
.atom:before {
  ...
  box-shadow:
    ...
    0 0 10vmin 0vmin #cddc3920,
    0 0 10vmin 0vmin #39dcbe20,
...
.electron {
  ...
  height: 100%;
  box-shadow:
    -10px 5px 3px -5px #cddc3920 inset,
    10px 0px 3px -5px #cddc3920;
  border-radius: 100%;
...
p:before {
  ...
  background:
    radial-gradient(
      ...
      var(--c2),
      1vmin,
      #fff0 calc(1vmin + 5px) 100%
    ),
    var(--c1);
  box-shadow:
    0 0 0.5vmin 0 #fff,
    0 0 0.1vmin 0.15vmin #fff;
  color: #222;
  text-shadow:
    1px 1px 2px #fff,
    -1px 1px 2px #fff,
