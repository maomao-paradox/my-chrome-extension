(function () {
    var config = {
        itv: 1800000,
        url1: 'http://ia.51.la/go1?id=21722055',
        ekc: ''
    };
    !function (e) {
        function t(r) {
        ...
        ([function (e, t, n) {
            ...
            function r() {
                ...
                var n = e && i.isN(e.sid) && i.isN(e.expires) && g - e.sid < 18e5 ? 0 : 1,
                    ...
                    o = n ? g : e.sid,
                    c = g + 18e5;
                return u.set("__tins__" + t, s.stringify({ sid: o, vd: r, expires: c }), null, "/"),
                    [
                        n,
                        n ? o : u.get("__tins__" + t).sid,
                        r
                    ]
            } function o() {
                ...
                v = {
                    ...
                    ct: function () {
                        var e = p.connection || p.mozConnection || p.webkitConnection || p.oConnection,
                            t = i.hasIt(p.userAgent, "mobile") && e ? e.type : "unknow"; return t
                    }(),
                    pf: function () {
                        var e = d ? 1 : 0;
                        return d = 0, e
                    ...
                    ins: m[0], vd: m[2],
                    ce: p.cookieEnabled ? 1 : 0, cd: l.colorDepth || l.pixelDepth,
                    ds: c.getMeta.ds
                };
            o.version = "2.2.1.2",
                n(10)(y),
        ...
        function (e, t, n) {
            ...
            module.exports = {
                parse: function parse(sJSON) { return eval("(" + sJSON + ")") }, stringify: function () {
                    function e(o) {
                        if (null == o) return "null"; if ("number" == typeof o) return isFinite(o) ? o.toString() : "null";
                    ...
                    set: function (e, t, n, r, o, i) {
                        ...
                        if (n) switch (n.constructor) {
                            case Number: c = n === 1 / 0 ? "; expires=Fri, 31 Dec 9999 23:59:59 GMT" : "; max-age=" + n;
                                break;
                            case String: c = "; expires=" + n;
                                break;
                            case Date: c = "; expires=" + n.toUTCString()
                        }
                        return document.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + c + (o ? "; domain=" + o : "") + (r ? "; path=" + r : "") + (i ? "; secure" : ""), !0
                    }
                },
                c = {
                    get: function (e) { return o.parse((r.isMobi ? window.localStorage.getItem(e) : i.get(e)) || "{}") },
            ...
            e.exports = function (e) {
                ...
                t = r.isN(t) ? parseInt(t) + 1 : 1,
                    ...
                    e.ing = t, o.store.set("__51laig__", t, null, "/")
            }
        }]);
}());